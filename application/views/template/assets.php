...
<script src="<?php echo base_url(); ?>assets/plugins/jquery-validation@1.19.2/jquery.validate.js"></script>
<script src="<?php echo base_url(); ?>assets/plugins/jquery-validation@1.19.2/additional-methods.js"></script>
    ...
    $(document).ready(function() {
        ...
        socket().on("connect", function() {
                ...
                socket().on('get notification',function(message){               
                    ...
                    if(message.channel.includes("<?php echo $this->session->userdata('office'); ?>")){
