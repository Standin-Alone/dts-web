      ...
      <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
          ...
          <div class="u-row-container"
            style="padding: 0px;background-image: url('<?=base_url()?>/assets/edcel_images/DA-Logo.png');background-repeat: no-repeat;background-position: center top;background-color: #eaeaea">
            <div class="u-row"
              style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
              <div style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="<?=base_url()?>assets/edcel_images/image-1.png" alt="Calendar"
                                      title="Calendar"
                              ...
                              <div
                                ...
                                <p style="font-size: 14px; line-height: 140%;"><strong><span
                                      style="font-size: 24px; line-height: 33.6px;"><span
                                        style="color: #000000; font-size: 24px; line-height: 33.6px;">Document Tracking System</span><span
                                        style="color: #000000; font-size: 24px; line-height: 33.6px;"></span></span></strong>
                                </p>
                              </div>
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="<?=base_url()?>assets/edcel_images/image-2.png" alt="user_icon"
                                      title="user_icon"
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="<?=base_url()?>assets/edcel_images/image-4.png" alt="Dollar" title="Dollar"
                          ...
                          <tr>
                            <td
                              ...
                              <div
                                ...
                                <p style="font-size: 14px; line-height: 140%;"><span
                                    style="font-size: 16px; line-height: 22.4px;"><span
                                      style="color: #969696; line-height: 22.4px; font-size: 16px;">Office:</span></span>
                                </p>
                                <p style="font-size: 14px; line-height: 140%;"><span
                                    style="font-size: 16px; line-height: 22.4px;"><strong><?=$office?></strong></span></p>
                              </div>
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="<?=base_url()?>assets/edcel_images/image-5.png" alt="Calendar"
                                      title="Calendar"
                              ...
                              <div style="line-height: 140%; text-align: center; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 140%;"><span
                                    style="font-size: 16px; line-height: 22.4px;"><span
                                      ...
                                      Time:</span></span></p>
                                <p style="font-size: 14px; line-height: 140%;"><strong><span
                                      style="font-size: 16px; line-height: 22.4px;"><?=date("F d, Y")?></span></strong>
                                </p>
                              </div>
                          ...
                          <tr>
                            <td
                              ...
                              <h4
                                ...
                                <br>
                                <br>
                                Thank you for using Document Tracking System!
                              </h4>
                              <br>
                            </td>
                          </tr>
